...
h);f--;a?0==f&&e():e()};b.on("load error",h);if("complete"==this.readyState)b.trigger("load");else if(this.readyState)this.src=this.src;else if(this.complete)b.trigger("load");else if(this.complete===ia){var u=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=u}}):e()}else e()}function Bb(b){for(var a=g.fn.jquery.split("."),e=a.length,f=0;f<e;f++){if(+a[f]<+b[f])return!1;if(+a[f]>+b[f])break}return!0}function Ba(b){return b.replace(/^\s+|\s+$/g,"")}
