...
function(a){if(c){c=!1;var f=a.options;f.ease=b;f.cssease=b;return $a(a)}return e(a)};var g,k,l,p,m,q=[],r=[],u=0,n,E,w,v,D=!1,x=0,y=0,H=0,I=0,B=function(e){if(X){var W=e.type,B,O,G,J="m"==W.substr(0,1);J?(B="mousedown",O="mouseup",G=""):(B="touchstart",O="touchend",G="touchcancel",e=e.originalEvent);if(!D){if(W!=B)return;var K=e.target,F=h(K);d[42]||(F=F.parents().add(K));K=d[42]||M;"string"===typeof K&&(K=ab(K),">"==K.charAt(0)&&(K=h(K.substr(1,K.length),M)));if(F.filter(K).length)D=!0;else return}if(W!=
O&&W!=G){J?(O=e.pageX,G=e.pageY):(G=e.touches[0],O=G.pageX,G=G.pageY);if(W==B)x=O,y=G,e=O-x,J=G-y,a.addClass("sudoSlider-dragging"),n=t,E=0,ka=!0,wa(),k=ub,g=tb,m=d[6]?Q(J):Q(e),p=l=+new Date,e=P(n),w=P(n+1)-e,v=!1;else{W=O-x;B=G-y;F=d[6]?B:W;K=Q(F);q[u]=K-m;var N=+new Date;r[u]=N-p;u=(u+1)%3;p=N;m=K;if(d[15]&&C>=T+1){K=0;if(F-E<w){v=!1;E+=w;var K=1,L=P(n+K);aa(n+K,0);var z=P(n+K)}0<F-E&&(K=-1,L=P(n),aa(n+K,0),z=P(n),F=P(n-1)-z,E+=F,v=-F);0!=K&&(n+=K,d[6]?k-=L-z:g-=L-z,w=P(n+1)-P(n))}d[6]?W=0:B=0;
A(g+W,k+B);L=O-x;L=Q(G-y)>Q(L);J=J?!1:d[45]?d[6]?!L:L:!1;J||e.preventDefault()}H=O-x;I=G-y}else{e=H;J=I;a.removeClass("sudoSlider-dragging");G=d[6]?J:e;G-=E;v&&(G-=v,n++);J=Q(G);O=+new Date;for(z=L=e=0;3>z;z++)W=r[z],W+100<O&&(e+=W,L+=q[z]);z=d[6]?M.height():M.width();O=Q(L)/e;e=.2<=O||J>=z/2;if(0<L&&0>J||0>L&&0<J||10>=J)e=!1;G=0>G?"next":"prev";d[15]||(t+1==C?"next"==G&&(e=!1):0==t&&"prev"==G&&(e=!1));G="next"==G?n+1:n-1;G=Ca(G,C);J=e?z-J:J;L=J/O*1.3;z=U(z/J*d[1],d[1]/4);L=L<z?Na(L,d[1]):Na(z,d[1]);
J=O*L/(J+O*L);O=1-J;b=d[38]?"cubic-bezier("+O+","+J+",0.3,1)":zb([O||0,J||0,.3,1]);X=!1;c=!0;e?Ha(G,L,!0,!0,!0):Ha(n,L,!0,!0,!0);D=!1}}};Fa(Ka,"touchstart touchmove touchend touchcancel",B);d[44]&&Fa(Ka,"mousedown mousemove mouseup",B)}function Ja(a){for(;a&&a.length;)a.splice(0,1)[0]()}function Ba(a,c,e){var g=fa(a),h="next"==a||"prev"==a;a=F(g);if(a!=t)if(X=!1,gb=a,d[30]){for(var k=0,l=a;l<a+T;l++){var n=F(l);Pa[n]&&(d[30]?d[30][n]?0:!Ea[n]||Ra[n]:1)||(k++,ua(n,function(){k--;0==k&&(d[40].call(b,
g+1),Ha(g,e,c,h))}))}0==k?Ha(g,e,c,h):d[39].call(b,g+1)}else Ha(g,e,c,h)}function wa(){d[38]&&B.css(ha+"transition-duration","")}function ta(a){a=F(a);if(a!=vb){vb=a;wa();for(var b=0;b<C;b++){var d=I[F(a+b)];B.append(d)}Y(t)}}function aa(a,b){var d=U(D((C-b-T)/2),0);a=Ca(a-d,C);ta(a)}function Ia(a){var b=Na(a,t);a=Q(a-t);aa(b,a)}function Ha(a,c,e,g,k){d[29]&&n(a);d[26]&&e&&(kb.location.hash=d[18][a]);d[4]&&u(a,d[3]);for(var l=h(),p=h(),m=0;m<T;m++)l=l.add(I[F(t+m)]),p=p.add(I[F(a+m)]);var m=a-t,q;
if(d[15]&&!g){g=Q(m);q=a;var r=-t+a+C;Q(r)<g&&(q=a+C,m=r,g=Q(m));r=-t+a-C;Q(r)<g&&(q=a-C,m=r)}else q=a;d[15]&&!k&&Ia(q);k=P(q,!1);g=P(q,!0);var w=I[F(a)],r=h.extend(!0,{},pa),v=d[1],x=w.attr("data-speed");x!=na&&(v=D(x));c!=na&&(v=D(c));r.speed=v;var y=d[0];(c=w.attr("data-effect"))&&(y=Oa(c));I[t]&&(c=I[t].attr("data-effectout"))&&(y=Oa(c));ka=!0;wb=y;var A=!0;ib=function(){A=ka=!1;Ua(a,e);screen.fontSmoothingEnabled&&p.style&&p.style.removeAttribute("filter");d[15]&&aa(q,0);ea(a,!0);d[10]&&E();
Ja(cb)};jb={fromSlides:l,toSlides:p,slider:M,container:B,options:r,to:a+1,from:t+1,diff:m,target:{left:k,top:g},stopCallbacks:[],callback:function(){A&&(A=!1,Ga())},goToNext:function(){A&&ia(h(".sudo-box",M),!0,N(Y,[a]))}};H(a,v);z(function(){ea(a,!1,!0,v);y.call(b,jb)})}function Ga(){if(ka){eb=!0;ib&&ib();Ja(jb.stopCallbacks);var a=wb.stop;a?a():(h(".sudo-box",M).remove(),B.stop());H(t,0);Y(t);eb=!1}}function Fa(a,b,c,d){a.on(b,d,c);xb.push(function(){a.off(b,d,c)})}function Ua(a,b){X=!b&&!d[12];
t=a;wa();H(t,0);t=F(t);d[29]||n(t);Y(t);X=!0;gb=!1;d[12]&&(b?(r(),d[14]&&p(d[14])):V||p());da();d[4]&&V&&u(t,0);!V||d[30][t]||Ea[t]||(V=!1,z(qa))}function ya(a,b){for(var c=h(),d=0;d<b;d++)c=c.add(I[F(a+d)]);return c}function F(a){return Ca(a,C)}function za(){r();Ga();H(t,0);ja=!0;ca=t;Ja(xb);wa();sa&&sa.remove();ta(0);Y(t);d[43].call(b)}function Aa(){ja&&c()}function Za(a){return function(){var b=!ja;za();a.apply(this,arguments);b&&Aa()}}var V,Sa,B,I,Pa,C,t,X,gb,Ta,db,ja,ca=!1,sa,mb,nb,fb,Xa,T,Wa,
M=h(this),rb,hb=0,ka=!1,wb,ib,jb,cb,Qa,Ea,Ra,Ya=!1,pb,qb,lb=!1,d=[],pa=h.extend(!0,{},a),ub,tb,xb=[],Va=!1,eb=!1,ob=-1,sb={},vb=0;b.destroy=za;b.init=Aa;b.getOption=function(a){return pa[a.toLowerCase()]};b.setOption=Za(function(a,b){pa[a.toLowerCase()]=b});b.setOptions=Za(function(a){for(var b in a)pa[b.toLowerCase()]=a[b]});b.runWhenNotAnimating=va;b.insertSlide=Za(function(a,b,c,e){b=0>b?C-Ca(-b-1,C+1):Ca(b,C+1);a=h(a||"<div>");Sa?a=h("<li>").prepend(a):1!=a.length&&(a=h("<div>").prepend(a));b&&
0!=b?I[b-1].after(a):B.prepend(a);e?ca=e-1:(b<=ca||!b||0==b)&&ca++;d[18].length<b&&(d[18].length=b);d[18].splice(b,0,c||D(b)+1)});b.removeSlide=Za(function(a){a=U(0,D(a)-1);I[Na(a,C-1)].remove();d[18].splice(a,1);a<ca&&ca--});b.goToSlide=function(a,b){var c=a==D(a)?a-1:a;z(N(g,[c,!0,b]))};b.block=function(){X=!1};b.unblock=function(){X=!0};b.startAuto=function(){d[12]=!0;p()};b.stopAuto=function(){d[12]=!1;r()};b.adjust=function Da(a){var b=U(hb-+new Date,0);H(t,b);ka||Y(t);a||z(N(Da,[!0]))};b.getValue=
