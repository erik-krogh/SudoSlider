...
f):g.animate(m,{queue:d,duration:a,easing:e[12],callback:f})}function w(b,a){Q(b,a,d);Q(b<A-K,a,f)}function E(b){b=I(b)+1;e[18]!=Ka||b!=A-K+1||e[16]||(b=A);if(e[18])for(var a=0;a<Ca.length;++a)P(Ca[a],b);e[2]&&P(h(e[2]),b)}function P(b,a){b.filter&&(b.filter(".current").removeClass("current"),b.filter(function(){var b=g(this);if(e[18]==Ka)for(var c=K-1;0<=c;c--){if(b==a-c)return f}else return b==a;return d}).addClass("current"))}function H(b,a,c){b=b.add(b.find("img")).filter("img");var d=b.length;
d?b.each(function(){var b=this;h(b).on("load error",function(){h(b).off("load error");b.naturalHeight&&!b.clientHeight&&h(b).height(b.naturalHeight).width(b.naturalWidth);a?(d--,0==d&&c()):c()});if("complete"==b.readyState)h(b).trigger("load");else if(b.readyState)b.src=b.src;else if(b.complete)h(b).trigger("load");else if(void 0===b.complete){var e=b.src;b.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";b.src=e}}):c()}function u(b,a){Wa=b=I(b);Na=+new Date+a;(e[28]||
...
A-K;return b>c?q==c&&a==aa?0:c:0>b?0==q&&a==ga?c:0:b}function ja(b,a){function c(){var a=new Image;a.src=m;var d=h(a);H(d,f,function(){ka(function(){var c="";d.height()||(c=20);d.height(c).width(c);k.empty().append(a);$(b,f)})})}if(a){var g=za[b];g||(g=za[b]=[]);g.push(a)}if(Aa[b])a&&H(b,f,function(){M(a)});else if(!qa[b]){qa[b]=f;Ea&&clearTimeout(Ea);var m=e[31][b],k=C[b],r=d;console.log("Loading: "+b);h.ajax({url:m,success:function(a,e,g){r=f;ka(function(){var e=g.getResponseHeader("Content-Type");
e&&"i"!=e.substr(0,1)?(k.html(a),$(b,d)):c()})},complete:function(){r||c()}});e[31][b]=d;ba.ajax[b]=d}}function ka(b){ia?La.push(b):M(b)}function $(b,a){var c=C[b];F(q);u(q,0);H(c,f,function(){ka(function(){F(q);u(q,0);Aa[b]=f;var c=za[b];c&&Z(c);n();M(function(){e[24].call(C[b],t(b)+1,a)});O&&(O=d,M(ea))})})}function ea(){e[16]&&Oa(q,0);u(q,0);F(q);T();e[11]&&p();e[13]&&k();e[23].call(c);H(ma(q,A),d,function(){ka(function(){u(q,0);F(q)})})}function Z(b){for(;b.length;)b.splice(0,1)[0]()}function fa(b){return ya[b]?
e[31]?e[31][b]||qa[b]&&!Aa[b]:f:d}function ua(b,a,g){var f=Y(b),m=b==aa||b==ga;b=I(f);if(b!=q)if(S=d,e[31]){for(var k=0,h=b;h<b+K;h++)fa(h)&&(k++,ja(I(h),function(){k--;0==k&&(e[42].call(c,f+1),Pa(f,g,a,m))}));0==k?Pa(f,g,a,m):e[41].call(c,f+1)}else Pa(f,g,a,m)}function Ja(){e[40]&&G.css(X+"transition-duration","")}function la(b){if(I(b)!=Xa){for(var a=0;a<A;a++)if(!fa(a))return;Xa=b;Ja();for(a=0;a<A;a++){var c=C[I(b+a)];G.append(c)}F(q)}}function Oa(b,a){var c=W(t((A-a-K)/2),0);b=((b-c)%A+A)%A;la(b)}
function va(b){var a=b<q?b:q;b=oa(b-q);Oa(a,b)}function Pa(b,a,g,m){e[30]&&E(b);e[27]&&g&&(ta.location.hash=e[19][b]);e[5]&&w(b,e[4]);for(var k=h(),r=h(),l=0;l<K;l++)k=k.add(C[I(q+l)]),r=r.add(C[I(b+l)]);var l=-q+b,n;if(e[16]&&!m){m=oa(l);n=b;var p=-q+b+A;oa(p)<m&&(n=b+A,l=p,m=oa(l));p=-q+b-A;oa(p)<m&&(n=b-A,l=p)}else n=b;e[16]&&va(n);m=N(n,d);var p=N(n,f),s=C[I(b)],x=h.extend(f,{},ba),v=e[1],z=s.attr("data-speed");void 0!=z&&(v=t(z));void 0!=a&&(v=t(a));x.speed=v;var y=e[0];(a=s.attr("data-effect"))&&
(y=pa(a));(a=C[q].attr("data-effectout"))&&(y=pa(a));ia=f;Ya=y;var B=f;Za=function(){B=ia=d;Da(b,g);screen.fontSmoothingEnabled&&r.style&&r.style.removeAttribute("filter");e[16]&&Oa(n,0);U(b,f);Z(La)};Qa={fromSlides:k,toSlides:r,slider:J,options:x,to:b+1,from:q+1,diff:l,target:{left:m,top:p},stopCallbacks:[],callback:function(){B&&(B=d,sa())},goToNext:function(){B&&F(b)}};u(b,v);M(function(){U(b,d,f);y.call(c,Qa)})}function sa(){if(ia){Za();Z(Qa.stopCallbacks);var b=Ya.stop;b?b():(h("."+wa,J).remove(),
G.stop());u(q,0);F(q)}}function Da(b,a){S=!a&&!e[13];q=b;u(q,0);q=I(q);e[30]||E(q);F(q);S=f;e[13]&&(a?(B(),e[15]&&k(e[15])):O||k());T();e[5]&&O&&w(q,0);!O||e[31][q]||qa[q]||(O=d,M(ea))}function ma(b,a){for(var c=h(),d=0;d<a;d++)c=c.add(C[I(b+d)]);return c}function I(b){return(b%A+A)%A}function Ha(){sa();ra=f;R=q;e[11]&&h(ta).off("resize focus",p);Ja();ha&&ha.remove();h(document).off("click",e[2],r);la(0);F(q);u(q,0)}function Ia(){ra&&m()}var O,Ba,G,C,ya,A,q,S,Ca,Ma,ra,R=d,ha,na,Sa,Ta,Fa,K,Ea,J=h(this),
Wa,Na=0,ia=d,Ya,Za,Qa,La,za,qa,Aa,Ga=d,Ua,Va,Ra=d,e=[],ba={};h.extend(f,ba,a);var Xa=0;c.destroy=Ha;c.init=Ia;c.getOption=function(b){return ba[b.toLowerCase()]};c.setOption=function(b,a){Ha();ba[b.toLowerCase()]=a;Ia()};c.runWhenNotAnimating=ka;c.insertSlide=function(b,a,c,d){Ha();a>A&&(a=A);b=h(b||"<div>");Ba?b=h("<li>").prepend(b):1!=b.length&&(b=h("<div>").prepend(b));a&&0!=a?C[a-1].after(b):G.prepend(b);d?R=d-1:(a<=R||!a||0==a)&&R++;e[19].length<a&&(e[19].length=a);e[19].splice(a,0,c||t(a)+1);
Ia()};c.removeSlide=function(a){a--;Ha();C[a].remove();e[19].splice(a,1);a<R&&R--;Ia()};c.goToSlide=function(a,c){var d=a==t(a)?a-1:a;M(function(){l(d,f,c)})};c.block=function(){S=d};c.unblock=function(){S=f};c.startAuto=function(){e[13]=f;k()};c.stopAuto=function(){e[13]=d;B()};c.adjust=function(){var a=W(Na-+new Date,0);u(q,a);ia||F(q)};c.getValue=function(a){return{currentslide:q+1,totalslides:A,clickable:S,destroyed:ra,autoanimation:Fa}[a.toLowerCase()]};c.getSlide=function(a){return C[I(t(a)-
