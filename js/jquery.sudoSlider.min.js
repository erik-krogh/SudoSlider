...
ba})}f&&(m?(N-=r/2,A+=r/2,Q-=u/2,aa+=u/2,u=r=0):(h.css({left:y+r/2,top:H+u/2}),v.css({left:P-r/2,top:z-u/2}),h.width(0).height(0),p&&h.css({borderRadius:T(w,n)})));m&&h.css({opacity:1});D++;Aa(function(){Ma.ready(function(){U(v,{left:N,top:Q},x,!1,!1,a);U(h,{opacity:m?0:1,width:r,height:u,left:A,top:aa,borderRadius:f&&m&&p?T(w,n):0},x,!1,function(){D--;0==D&&a.callback()},a)})},k)}m||150>k?l(k):Aa(N(l,[150]),k-150)})(v[k],r);r+=x/n.length*1.5}}function ca(a,b,d,f,G,l,q,m){for(var p=a.options,r=p.slices,
v=p.speed/2,p=a.slider,k=Ka(a,b?r:1,b?1:r,!m),h=g(),x=0;x<k.length;x++)h=h.add(k[x]());var u=0,n=!1;d?fa(h):g(fa(h.get())).appendTo(p);f&&va(h);h.each(function(f){f*=v/r;var k=g(this),h=k.width(),p=k.height(),x=k.css("left"),D=k.css("top"),A=b?x:D,P=k.children()[b?"width":"height"]();1==l?A=0:2==l&&(A=P/2);d&&(A=P-A);b?k.css({width:G||q?h:0,left:A}):k.css({height:G||q?p:0,top:A});m&&(A=1==q?-1:1,k.css({top:D,left:x,width:h,height:p,opacity:1}),b?D=A*p:x=A*h);q&&(A=!0,3==q?n=n?A=!1:!0:2==q&&(A=!1),
...
this.src;else if(this.complete)a.trigger("load");else if(this.complete===oa){var q=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=q}}):d()}else d()}function yb(a){for(var b=g.fn.jquery.split("."),d=b.length,f=0;f<d;f++)if(a[f]&&+b[f]<+a[f])return!1;return!0}function Ea(a){return a.replace(/^\s+|\s+$/g,"")}function Oa(a){var b=[],d;for(d in a)b.push(d);return b}function z(a){setTimeout(a,0)}function Aa(a,b){return setTimeout(a,b)}function fa(a){return[].reverse.call(a)}
function Na(a){return a.children().not(".sudo-box")}function sa(a){var b={},d;for(d in a)b[d.toLowerCase()]=a[d];return b}function va(a){for(var b,d,f=a.length;f;b=Math.random()*f|0,d=a[--f],a[f]=a[b],a[b]=d);return a}function D(a){return parseInt(a,10)}function ga(a){return parseFloat(a)}function Fa(a,b){return(a%b+b)%b||0}function Q(a){return 0>a?-a:a}function T(a,b){return a>b?a:b}function Pa(a,b){return a<b?a:b}function Qa(a){if(g.isArray(a))return pa(a);if(g.isFunction(a))return a;a=Ea(a);if(-1!=
a.indexOf(",")){var b=a.split(",");return pa(b)}var d=sa(ea);a=Ea(a.toLowerCase());if(b=d[a])return b;var b=[],f;for(f in d)f.match(new RegExp("^"+a.split("*").join(".*")+"$","g"))&&b.push(d[f]);return b.length?pa(b):bb}function pa(a){return function(b){var d=za(a);return Qa(d)(b)}}function za(a){return a[va(Oa(a))[0]]}function zb(a){var b="bez_"+a.join("_").replace(/\./g,"p"),d=g.easing;if(!g.isFunction(d[b])){var f=function(a,b){function d(q,k){r[k]=3*a[k];g[k]=3*(b[k]-a[k])-r[k];f[k]=1-r[k]-g[k];
...
g(la),Ma=g(document);g.fn.sudoSlider=function(a){var b=this;a=g.extend(sa(ra()),sa(a));!1!==ha&&yb([1,8,0])||(a.usecss=!1);return this.each(function(){function d(){var e=0,a;for(a in qa)c[e]=qa[a],e++;V=!0;Ra=[];db=[];Sa=[];Ha=[];Ta=[];B=Na(M);e=B.length;a=g("<div>");e?(Ua=B.is("ul"))||B.hasClass("slidesContainer")||lb||(a.append(B),M.append(B=a)):(M.append(B=a),Ua=!1);lb=!0;e=Na(B);I=[];C=e.length;e.each(function(e,a){var b=g(a);I[e]=b;b.css({position:"relative"});"none"==b.css("display")&&b.css("display",
"inline")});B.addClass("slidesContainer");e.addClass("slide");e.each(function(e,a){g(a).attr("data-slide",e+1)});if(c[30]&&(a=c[30].length,a>C)){for(e=1;e<=a-C;e++){var b;b=Ua?"li":"div";b=g("<"+b+">"+c[32]+"</"+b+">");B.append(b);I[C+(e-1)]=b}e=Na(B);C=a}e.each(function(e,a){Ra[e]=!1;ia(g(a),!0,function(){Ra[e]=!0})});t=(t=!1===da?0:da)||0;X=!0;Va=[];ja=!1;M.css({overflow:"hidden"});"static"==M.css("position")&&M.css({position:"relative"});e.css({"float":"left",listStyle:"none"});B.add(e).css({display:"block",
...
!ja){var a=ib-+new Date,a=T(a,0),b={};c[27]&&(b.height=R(e,!0)||1);c[28]&&(b.width=R(e,!1)||1);var d;a:if(e=sb,Oa(e).length!=Oa(b).length)d=!1;else{for(d in e)if(e[d]!=b[d]){d=!1;break a}d=!0}d||(sb=b,c[38]?U(M,b,a,c[46]):0==a?M.stop().css(b):M.animate(b,{queue:!1,duration:a,easing:c[11]}))}}function Y(e){var a=P(e,!1);e=P(e,!0);A(a,e)}function A(e,a,b){tb=e;ub=a;(c[38]||b)&&B.css({transform:"translate("+e+"px, "+a+"px)"});if(!c[38]||b)B.css({marginLeft:0,marginTop:0}),B.css({marginLeft:e,marginTop:a})}
...
0>a?0==t&&"prev"==b?d:0:a}function wa(a,b){function d(){var b=new Image;b.src=h;var c=g(b);ia(c,!0,N(xa,[function(){k.empty().append(b);na(a,!0)}]))}if(b){var f=Sa[a];f||(f=Sa[a]=[]);f.push(b)}if(Ta[a])b&&ia(I[a],!0,N(z,[b]));else if(!Ha[a]){Ha[a]=!0;var h=c[30][a];if(h){Ya&&clearTimeout(Ya);var k=I[a],l=!1;g.ajax({url:h,success:function(b,c,f){l=!0;xa(function(){var c=f.getResponseHeader("Content-Type");c&&"i"!=c.substr(0,1)?(k.html(b),na(a,!1)):d()})},complete:function(){l||d()}});c[30][a]=!1;qa.ajax[a]=
!1}else z(b)}}function xa(a){ka?db.push(a):z(a)}function na(a,d){var f=I[a];Y(t);H(t,0);ia(f,!0,N(xa,[function(){Y(t);H(t,0);Ta[a]=!0;La(Sa[a]);m();z(function(){c[23].call(I[a],a+1,d,b)});V&&(V=!1,z(pa))}]))}function pa(){c[15]&&ba(t,0);H(t,0);Y(t);ca();c[10]&&G();c[12]&&p();c[22].call(b);c[41]&&va();ia(Ba(t,C),!1,N(xa,[function(){H(t,0);Y(t)}]))}function va(){var a=g("body"),b,d=!1,f=c[0];c[0]=function(a){if(d){d=!1;var e=a.options;e.ease=b;e.cssease=b;return bb(a)}return f(a)};var h,k,l,p,m,q=[],
r=[],u=0,n,v,w,G,D=!1,x=0,y=0,H=0,I=0,B=function(f){if(X){var W=f.type,B,O,F,J="m"==W.substr(0,1);J?(B="mousedown",O="mouseup",F=""):(B="touchstart",O="touchend",F="touchcancel",f=f.originalEvent);if(!D){if(W!=B)return;var L=f.target,E=g(L);c[42]||(E=E.parents().add(L));L=c[42]||M;"string"===typeof L&&(L=Ea(L),">"==L.charAt(0)&&(L=g(L.substr(1,L.length),M)));if(E.filter(L).length)D=!0;else return}if(W!=O&&W!=F){J?(O=f.pageX,F=f.pageY):(F=f.touches[0],O=F.pageX,F=F.pageY);if(W==B){x=O;y=F;var J=O-
...
O-x;I=F-y}else{f=H;J=I;a.removeClass("sudoSlider-dragging");F=c[6]?J:f;F-=v;G&&(F-=G,n++);J=Q(F);O=+new Date;for(z=K=f=0;3>z;z++)W=r[z],W+100<O&&(f+=W,K+=q[z]);z=c[6]?M.height():M.width();O=Q(K)/f;f=.2<=O||J>=z/2;if(0<K&&0>J||0>K&&0<J||10>=J)f=!1;F=0>F?"next":"prev";c[15]||(t+1==C?"next"==F&&(f=!1):0==t&&"prev"==F&&(f=!1));F="next"==F?n+1:n-1;F=Fa(F,C);J=f?z-J:J;K=J/O*1.3;z=T(z/J*c[1],c[1]/4);K=K<z?Pa(K,c[1]):Pa(z,c[1]);J=O*K/(J+O*K);O=1-J;b=c[38]?"cubic-bezier("+O+","+J+",0.3,1)":zb([O||0,J||0,.3,
1]);X=!1;d=!0;f?Ja(F,K,!0,!0,!0):Ja(n,K,!0,!0,!0);D=!1}}};ta(Ma,"touchstart touchmove touchend touchcancel",B);c[44]&&ta(Ma,"mousedown mousemove mouseup",B)}function La(a){for(;a&&a.length;)a.splice(0,1)[0]()}function za(a,d,f){var g=fa(a),h="next"==a||"prev"==a;a=E