...
nextHtml:'<a href="#" class="nextBtn"> next </a>',controlsAttr:'class="controls"',numericAttr:'class="numericControls"',interruptible:!1,useCSS:!0,loadStart:A,loadFinish:A,touch:!1,touchHandle:!1,destroyCallback:A,mouseTouch:!0,allowScroll:!0,CSSease:"swing"}}function ba(a,b,c,f,J){if(h.isFunction(b))f?ba(a,["","Up","Right","Down","Left",b],c,0,J):a[c]=function(a){var c=[a].concat(J),l=c.length-1;if(0===f&&0==c[l]){var k=a.diff;c[l]=a.options.vertical?0>k?1:3:0>k?2:4}b.apply(this,c)};else if(h.isArray(b))for(var k=
b.length-1,r=b[k],n=0;n<k;n++){var p=J.slice();p.push(n);ba(a,r,c+b[n],f,p)}else h.each(b,function(b,k){ba(a,k,c+b,f,J)})}function ha(a,b,c,f,J,k,r,n,p){var q=a.options,v=q.boxrows,l=q.boxcols,g=v*l,z=q.speed/(1==g?1:2.5),m=Ga(a,l,v,!n),u=q=0,H=0,I=[];I[u]=[];b&&na(m);J&&oa(m);for(var w=0;w<m.length;w++)I[u][H]=m[w],H++,H==l&&(c&&na(I[u]),u++,H=0,I[u]=[]);u=[];if(1==k)for(m=0;m<2*l+1;m++){g=m;w=[];for(k=0;k<v;k++){if(0<=g&&g<l){H=I[k][g];if(!H)return;w.push(H)}g--}0!=w.length&&u.push(w)}else if(2==
k){var I=v/2,H=b?g:-1,W=b?-1:1;for(k=0;k<I;k++){for(g=w=k;g<l-k-1;g++)u[H+=W]=m[w*l+g];g=l-k-1;for(w=k;w<v-k-1;w++)u[H+=W]=m[w*l+g];w=v-k-1;for(g=l-k-1;g>k;g--)u[H+=W]=m[w*l+g];g=k;for(w=v-k-1;w>k;w--)u[H+=W]=m[w*l+g]}}else for(m=0;m<v;m++)for(g=0;g<l;g++)u.push([I[m][g]]);n&&a.goToNext();for(var D=0,w=0;w<u.length;w++){v=u[w];h.isArray(v)||(v=[v]);for(l=0;l<v.length;l++)(function(k,l){function h(l){var g=k(),v=g.children(),u=g.width(),w=g.height(),q=u,m=w,H=ia(g.css("left")),I=ia(g.css("top")),B=
H,W=I,O=ia(v.css("left")),C=ia(v.css("top")),G=O,P=C;if(r){var X,A;J?(A=ua([-q,q]),X=ua([-m,m])):(A=b!=c?-q:q,X=b?-m:m);n?(B-=1.5*A,W-=1.5*X):g.css({left:H+1.5*A,top:I+1.5*X})}f&&(n?(G-=q/2,B+=q/2,P-=m/2,W+=m/2,m=q=0):(g.css({left:H+q/2,top:I+m/2}),v.css({left:O-q/2,top:C-m/2}),g.width(0).height(0),p&&g.css({borderRadius:R(w,u)})));n&&g.css({opacity:1});D++;va(function(){Ia.ready(function(){S(v,{left:G,top:P},z,!1,!1,a);S(g,{opacity:n?0:1,width:q,height:m,left:B,top:W,borderRadius:f&&n&&p?R(w,u):
0},z,!1,function(){D--;0==D&&a.callback()},a)})},l)}n||150>l?h(l):va(G(h,[150]),l-150)})(v[l],q);q+=z/u.length*1.5}}function Y(a,b,c,f,J,k,r,n){for(var p=a.options,q=p.slices,v=p.speed/2,p=a.slider,l=Ga(a,b?q:1,b?1:q,!n),g=h(),z=0;z<l.length;z++)g=g.add(l[z]());var m=0,u=!1;c?na(g):h(na(g.get())).appendTo(p);f&&oa(g);g.each(function(f){f*=v/q;var l=h(this),g=l.width(),p=l.height(),z=l.css("left"),D=l.css("top"),B=b?z:D,O=l.children()[b?"width":"height"]();1==k?B=0:2==k&&(B=O/2);c&&(B=O-B);b?l.css({width:J||
r?g:0,left:B}):l.css({height:J||r?p:0,top:B});n&&(B=1==r?-1:1,l.css({top:D,left:z,width:g,height:p,opacity:1}),b?D=B*p:z=B*g);r&&(B=!0,3==r?u=u?B=!1:!0:2==r&&(B=!1),b?n?D=(B?-1:1)*p:l.css({bottom:B?0:p,top:B?p:0,height:n?p:0}):n?z=(B?-1:1)*g:l.css({right:B?0:g,left:B?g:0,width:n?g:0}));m++;va(G(S,[l,{width:g,height:p,opacity:n?0:1,left:z,top:D},v,!1,function(){m--;0==m&&a.callback()},a]),f)});n&&a.goToNext()}function wa(a,b,c){var f=2==c||4==c;c=2==c||3==c?1:-1;var h=a.options.speed,k=a.callback;
...
marginLeft:h},c,!1,a.callback,a)}function S(a,b,c,f,h,k,r){function n(){if(!r){var b={};b[l]="0s";b[g]="";b[v]="";a.css(b)}}var p=!k||k.options.usecss;if(!1!==da&&p){f||(f=k.options.cssease);var q={},v=da+"transition",p=Ka(b);q[v]=p.join(" ")+(""==da?"":" "+da+p.join(" "+da));var l=v+"-duration";q[l]=c+"ms";var g=v+"-timing-function";"swing"==f&&(f="ease-in-out");q[g]=f;k&&k.stopCallbacks.push(n);f=da.replace(/\-/g,"");var z=f+((f?"T":"t")+"ransitionend")+" transitionend",m=!1,u=function(){m||(m=
!0,a.unbind(z),n(),h&&h())};if(20>c)a.css(b),u();else return C(function(){a.css(q);C(function(){a.css(b);var f=+new Date;a.on(z,function w(b){a.is(b.target)&&-100<+new Date-f-c&&(a.off(z,w),u())});setTimeout(u,c+100)})}),u}else f||(f=k.options.ease),a.animate(b,c,f,h)}function xa(a,b){var c=a.options;c.boxcols=1;c.boxrows=1;c.speed=b;ha(a,!1)}function Ga(a,b,c,f){function J(b,c){n.push(function(){var g=ca(a,f),g=ya(g,l*b,v*c,l,v);k.append(g);return g})}var k=a.slider,r=a.options.vertical,n=[],p;p=
r?f?a.toSlides.width():a.slider.width():0;var q;q=r?0:f?a.toSlides.height():a.slider.height();a.toSlides.each(function(){var a=h(this);r?q+=a.height():p+=a.width()});for(var v=Math.ceil(p/b),l=Math.ceil(q/c),g=0;g<c;g++)for(var z=0;z<b;z++)J(g,z);return n}function ya(a,b,c,f,J){a.css({width:a.width(),height:a.height(),display:"block",top:-b,left:-c});return h("<div>").css({left:c,top:b,width:J,height:f,opacity:0,overflow:"hidden",position:"absolute"}).append(a).addClass("sudo-box")}function ca(a,
...
da=function(){var a;a:{var b=h("<div>")[0].style;for(a in b)if(b=a.toLowerCase(),-1!==b.indexOf("transition",b.length-10))break a;a=!1}if(!1===a)return!1;a=a.slice(0,a.length-10);return 0!=a.length?"-"+a+"-":""}(),Za=h(gb),Ia=h(document);h.fn.sudoSlider=function(a){var b=this;a=h.extend(za(qa()),za(a));!1!==da&&ub([1,8,0])||(a.usecss=!1);return this.each(function(){function c(){var e=0,a;for(a in la)d[e]=la[a],e++;T=!0;Na=[];$a=[];Oa=[];Ca=[];Pa=[];x=Ja(M);e=x.length;a=h("<div>");e?(Qa=x.is("ul"))||
x.hasClass("slidesContainer")||hb||(a.append(x),M.append(x=a)):(M.append(x=a),Qa=!1);hb=!0;e=Ja(x);y=[];E=e.length;e.each(function(e,a){var b=h(a);y[e]=b;b.css({position:"relative"});"none"==b.css("display")&&b.css("display","inline")});x.addClass("slidesContainer");e.addClass("slide");e.each(function(e,a){h(a).attr("data-slide",e+1)});if(d[30]&&(a=d[30].length,a>E)){for(e=1;e<=a-E;e++){var b;b=Qa?"li":"div";b=h("<"+b+">"+d[32]+"</"+b+">");x.append(b);y[E+(e-1)]=b}e=Ja(x);E=a}e.each(function(e,a){Na[e]=
!1;ea(h(a),!0,function(){Na[e]=!0})});t=(t=!1===Z?0:Z)||0;U=!0;Ra=[];ga=!1;M.css({overflow:"hidden"});"static"==M.css("position")&&M.css({position:"relative"});e.css({"float":"left",listStyle:"none"});x.add(e).css({display:"block",position:"relative",margin:"0"});B(0,0,!0);d[7]=D(d[7]);Q=d[7];d[7]+=d[8]-1;d[9]=D(d[9])-1||0;d[0]=Ma(d[0]);d[18]=d[18].slice(0);for(e=0;e<E;e++)d[18][e]||""==d[18][e]||(d[18][e]=e+1),d[30][e]=d[30][e]||!1;d[4]=d[4]&&!d[15];d[10]&&J(!0);x[d[6]?"height":"width"](9E6)[d[6]?
...
0;a<Ra.length;++a)H(Ra[a],e);d[2]&&H(h(d[2]),e)}function H(e,a){e&&e.filter&&(e.filter(".current").removeClass("current"),e.filter(function(){var e=k(this);if("pages"==d[17])for(var b=Q-1;0<=b;b--){if(e==a-b)return!0}else return e==a;return!1}).addClass("current"))}function I(e,a){nb=e=N(e);db=+new Date+a;(d[27]||d[28])&&w(e)}function w(e){M.ready(function(){Y(e);ea(y[e],!1,G(Y,[e]))})}function A(e,a){for(var b=0,c=e;c<e+Q;c++){var f=y[N(c)];f&&(f=f["outer"+(a?"Height":"Width")](!0),b=a==d[6]?b+f:
R(f,b))}return b}function Y(e){if(e==nb&&M.is(":visible")&&!T&&!ga){var a=db-+new Date,a=R(a,0),b={};d[27]&&(b.height=A(e,!0)||1);d[28]&&(b.width=A(e,!1)||1);var c;a:if(e=ob,Ka(e).length!=Ka(b).length)c=!1;else{for(c in e)if(e[c]!=b[c]){c=!1;break a}c=!0}c||(ob=b,d[38]?S(M,b,a,d[46]):0==a?M.stop().css(b):M.animate(b,{queue:!1,duration:a,easing:d[11]}))}}function V(e){var a=O(e,!1);e=O(e,!0);B(a,e)}function B(e,a,b){pb=e;qb=a;(d[38]||b)&&x.css({transform:"translate("+e+"px, "+a+"px)"});if(!d[38]||
b)x.css({marginLeft:0,marginTop:0}),x.css({marginLeft:e,marginTop:a})}function O(a,b){b==ja&&(b=d[6]);var c=y[N(a)];return c&&c.length?-c.position()[b?"top":"left"]:0}function aa(){if(!1!==Wa){var a=Wa;Wa=!1;C(G(g,[a,lb,mb]))}}function ba(a,b,d,c){a=N(a);a=G(b?ha:na,[y[a],a+1,c]);d?a():C(a)}function ha(a,c){d[25].call(a,c,b)}function na(a,c,f){d[24].call(a,c,b,f)}function ia(a){return"next"==a?ca(t+d[8],a):"prev"==a?ca(t-d[8],a):"first"==a?0:"last"==a?E-1:ca(D(a),a)}function ca(a,b){if(d[15])return"next"==
...
a;f.cssease=a;return Ya(d)}return c(d)};var f,g,l,k,p,n=[],r=[],q=0,m,u,v,w,J=!1,D=0,z=0,H=0,I=0,y=function(c){if(U){var y=c.type,fa,x,F,K="m"==y.substr(0,1);K?(fa="mousedown",x="mouseup",F=""):(fa="touchstart",x="touchend",F="touchcancel",c=c.originalEvent);if(!J){if(y!=fa)return;var G=c.target,C=h(G);d[42]||(C=C.parents().add(G));if(C.filter(d[42]||M).length)J=!0;else return}if(y!=x&&y!=F){K?(x=c.pageX,F=c.pageY):(F=c.touches[0],x=F.pageX,F=F.pageY);if(y==fa)D=x,z=F,c=x-D,K=F-z,m=t,u=0,ma=!0,ta(),
g=qb,f=pb,p=d[6]?P(K):P(c),k=l=+new Date,c=O(m),v=O(m+1)-c,w=!1;else{y=x-D;fa=F-z;G=d[6]?fa:y;C=P(G);n[q]=C-p;var N=+new Date;r[q]=N-k;q=(q+1)%3;k=N;p=C;if(d[15]&&E>=Q+1){C=0;if(G-u<v){w=!1;u+=v;var C=1,L=O(m+C);X(m+C,0);var A=O(m+C)}0<G-u&&(C=-1,L=O(m),X(m+C,0),A=O(m),G=O(m-1)-A,u+=G,w=-G);0!=C&&(m+=C,d[6]?g-=L-A:f-=L-A,v=O(m+1)-O(m))}d[6]?y=0:fa=0;B(f+y,g+fa);L=x-D;L=P(F-z)>P(L);K=K?!1:d[45]?d[6]?!L:L:!1;K||c.preventDefault()}H=x-D;I=F-z}else{F=d[6]?I:H;F-=u;w&&(F-=w,m++);K=P(F);x=+new Date;for(A=
L=c=0;3>A;A++)y=r[A],y+100<x&&(c+=y,L+=n[A]);A=d[6]?M.height():M.width();x=P(L)/c;c=.2<=x||K>=A/2;if(0<L&&0>K||0>L&&0<K||10>=K)c=!1;F=0>F?"next":"prev";d[15]||(t+1==E?"next"==F&&(c=!1):0==t&&"prev"==F&&(c=!1));F="next"==F?m+1:m-1;F=Aa(F,E);K=c?A-K:K;L=K/x*1.3;A=R(A/K*d[1],d[1]/4);L=L<A?La(L,d[1]):La(A,d[1]);K=x*L/(K+x*L);x=1-K;a=d[38]?"cubic-bezier("+x+","+K+",0.3,1)":vb([x||0,K||0,.3,1]);U=!1;b=!0;c?Fa(F,L,!0,!0,!0):Fa(m,L,!0,!0,!0);J=!1}}};Da(Ia,"touchstart touchmove touchend touchcancel",y);d[44]&&
Da(Ia,"mousedown mousemove mouseup",y)}function Ha(a){for(;a&&a.length;)a.splice(0,1)[0]()}function za(a,c,f){var g=ia(a),h="next"==a||"prev"==a;a=N(g);if(a!=t)if(U=!1,d[30]){for(var k=0,l=a;l<a+Q;l++){var m=N(l);Na[m]&&(d[30]?d[30][m]?0:!Ca[m]||Pa[m]:1)||(k++,ra(m,function(){k--;0==k&&(d[40].call(b,g+1),Fa(g,f,c,h))}))}0==k?Fa(g,f,c,h):d[39].call(b,g+1)}else Fa(g,f,c,h)}function ta(){d[38]&&x.css(da+"transition-duration","")}function qa(a){a=N(a);if(a!=rb){rb=a;ta();for(var b=0;b<E;b++){var c=y[N(a+
b)];x.append(c)}V(t)}}function X(a,b){var c=R(D((E-b-Q)/2),0);a=Aa(a-c,E);qa(a)}function Ga(a){var b=La(a,t);a=P(a-t);X(b,a)}function Fa(a,c,f,g,k){d[29]&&u(a);d[26]&&f&&(gb.location.hash=d[18][a]);d[4]&&m(a,d[3]);for(var l=h(),p=h(),n=0;n<Q;n++)l=l.add(y[N(t+n)]),p=p.add(y[N(a+n)]);var n=a-t,q;if(d[15]&&!g){g=P(n);q=a;var r=-t+a+E;P(r)<g&&(q=a+E,n=r,g=P(n));r=-t+a-E;P(r)<g&&(q=a-E,n=r)}else q=a;d[15]&&!k&&Ga(q);k=O(q,!1);g=O(q,!0);var v=y[N(a)],r=h.extend(!0,{},la),w=d[1],A=v.attr("data-speed");
A!=ja&&(w=D(A));c!=ja&&(w=D(c));r.speed=w;var z=d[0];(v=v.attr("data-effect"))&&(z=Ma(v));y[t]&&(v=y[t].attr("data-effectout"))&&(z=Ma(v));ma=!0;sb=z;var B=!0;eb=function(){B=ma=!1;Sa(a,f);screen.fontSmoothingEnabled&&p.style&&p.style.removeAttribute("filter");d[15]&&X(q,0);ba(a,!0,c);d[10]&&J();Ha($a)};fb={fromSlides:l,toSlides:p,slider:M,container:x,options:r,to:a+1,from:t+1,diff:n,target:{left:k,top:g},stopCallbacks:[],callback:function(){B&&(B=!1,Ea())},goToNext:function(){B&&ea(h(".sudo-box",
M),!0,G(V,[a]))}};I(a,w);C(function(){ba(a,!1,!0,c);z.call(b,fb)})}function Ea(){if(ma){bb=!0;eb&&eb();Ha(fb.stopCallbacks);var a=sb.stop;a?a():(h(".sudo-box",M).remove(),x.stop());I(t,0);V(t);bb=!1}}function Da(a,b,c,d){a.on(b,d,c);tb.push(function(){a.off(b,d,c)})}function Sa(a,b){U=!b&&!d[12];t=a;ta();I(t,0);t=N(t);d[29]||u(t);V(t);U=!0;d[12]&&(b?(q(),d[14]&&p(d[14])):T||p());aa();d[4]&&T&&m(t,0);!T||d[30][t]||Ca[t]||(T=!1,C(oa))}function wa(a,b){for(var c=h(),d=0;d<b;d++)c=c.add(y[N(a+d)]);return c}
function N(a){return Aa(a,E)}function xa(){q();Ea();I(t,0);ga=!0;Z=t;Ha(tb);ta();pa&&pa.remove();qa(0);V(t);d[43].call(b)}function ya(){ga&&c()}function Xa(a){return function(){var b=!ga;xa();a.apply(this,arguments);b&&ya()}}var T,Qa,x,y,Na,E,t,U,Ra,ab,ga,Z=!1,pa,ib,jb,cb,Va,Q,Ua,M=h(this),nb,db=0,ma=!1,sb,eb,fb,$a,Oa,Ca,Pa,Wa=!1,lb,mb,hb=!1,d=[],la=h.extend(!0,{},a),qb,pb,tb=[],Ta=!1,bb=!1,kb=-1,ob={},rb=0;b.destroy=xa;b.init=ya;b.getOption=function(a){return la[a.toLowerCase()]};b.setOption=Xa(function(a,
b){la[a.toLowerCase()]=b});b.setOptions=Xa(function(a){for(var b in a)la[b.toLowerCase()]=a[b]});b.runWhenNotAnimating=sa;b.insertSlide=Xa(function(a,b,c,f){b=0>b?E-Aa(-b-1,E+1):Aa(b,E+1);a=h(a||"<div>");Qa?a=h("<li>").prepend(a):1!=a.length&&(a=h("<div>").prepend(a));b&&0!=b?y[b-1].after(a):x.prepend(a);f?Z=f-1:(b<=Z||!b||0==b)&&Z++;d[18].length<b&&(d[18].length=b);d[18].splice(b,0,c||D(b)+1)});b.removeSlide=Xa(function(a){a=R(0,D(a)-1);y[La(a,E-1)].remove();d[18].splice(a,1);a<Z&&Z--});b.goToSlide=
