...
Z){var d=a.src;a.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";a.src=d}})}function T(d,b){a[18]&&ua(d,b,e);a[38]&&ua(d,b,c)}function ua(a,b,e){H.ready(function(){va(a,b,e);ja(n.eq(a),c,function(){va(a,b,e)})})}function va(d,b,e){d=w(d);l=n.eq(d)[e?"height":"width"]();H.animate(e?{height:l}:{width:l},{queue:c,duration:b,easing:a[8]})}function U(){q.css("margin-left",ca(g,c)).css("margin-top",ca(g,e))}function ca(d,b){d=x.eq(d+(R?a[39]:0));return d.length?-d.position()[b?
"top":"left"]:0}function ya(){g=w(g);a[23]||ka(g);U();m=e;a[16]&&ia&&(window.location.hash=a[15][g]);!u&&V&&I(g,e)}function I(a,c){var a=w(a),e=f();for(b in v[a])e=e.add(v[a][b]);(c?za:Aa)(e,a+1)}function za(d,b){f.isFunction(a[29])&&a[29].call(d,b)}function Aa(d,b){f.isFunction(a[28])&&a[28].call(d,b)}function W(d){return"next"==d?la(g+1+a[41],d):"prev"==d?la(g-1-a[41],d):"first"==d?0:"last"==d?P:la(o(d),d)}function la(d,b){if(a[11])return w(d);var c=k-s;return d>c?g==c&&"next"==b?0:c:0>d?0==g&&
...
T(d,g);ja(m,e,function(){i===e&&U();f.isFunction(h)&&h();ha()});f.isFunction(a[27])&&a[27].call(m,o(d)+1,j);2==h&&(I(d,c),V||(I(d,e),V=e))}function sa(d,p,h){if(W(d)!=g&&!z&&m){Q=c;a[23]&&ka(W(d));if(!(t||0==t))var t=!p&&!a[9]&&a[16]?a[22]*(a[17]/a[7]):a[22],i=W(d);if(a[2]){var j=i,l=a[1];ba(j,l,c);ba(j<k-s,l,e)}if(h)t=da,K&&K--;else if(a[24]){K=0;da=t;for(b=i;b<i+s;b++)a[24][b]&&(E(w(b),c,t,function(){sa(d,p,e)}),K++)}else K=c;if(!K)if(m=!p,T(i,a[22]),I(i,c),a[21]){var q=e,h=0;for(b=i;b<i+s;b++)n.eq(w(b)).clone().prependTo(H).css({"z-index":"10000",
...
this.style.removeAttribute("filter");a[16]&&p&&(window.location.hash=a[15][g]);m=e;u=c;I(i,e)}})}})})}}}function G(d,f,h,j,i){if(m&&(!z&&(d!=g||J))&&k>w(d)||j){j||(Q=c);m=!f&&!a[9];ia=f;C=g;g=d;a[23]&&ka(g);var l=Math.sqrt(Math.abs(C-g));if(!(i||0==i))var i=!h?0:!f&&!a[9]?o(l*a[17]):o(l*a[7]),n=w(g);if(j)i=da,X&&X--;else if(a[24]){a[24][n]&&(E(n,e,J||i,2),Q=e);if(!u){j=C>g?g:C;l=C>g?C:g;X=0;da=i;for(b=j;b<=l;b++)b<=P&&(0<=b&&a[24][b])&&(E(b,c,i,function(){G(d,f,h,e)}),X++)}for(b=n+1;b<=n+s;b++)a[24][b]&&
E(b,c,0,c)}X||(!u&&!Q&&(I(n,c),V=e),u||T(g,i),q.animate({marginTop:ca(g,e),marginLeft:ca(g,c)},{queue:c,duration:i,easing:a[8],complete:ya}),a[2]&&(j=a[1],!f&&!a[9]&&(j=a[17]/a[7]*a[1]),h||(j=0),u&&(j=o(0.6*a[22])),i=g,ba(i,j,c),ba(i<k-s,j,e)),J&&(a[24][n]||ha()),J=c)}}function w(a){for(a=o(a);0>a;)a+=k;return a%k}function o(a){return parseInt(a,10)}function ea(){L=g;a[42]&&f(window).off("resize focus",M);F&&F.remove();z=e;f(a[19]).die("click");if(R)for(b=1;b<=a[39];b++)x.eq(b-1).add(x.eq(-b)).remove();
U()}function fa(){z&&B(H,L)}var J,q,n,x,k,g,C,P,m,ia,u,Q,$,na,z,F,oa,pa,qa,ra,A,L,da,X,K,S,b,l,h,R,s,V=c,aa,v=[],H=f(this),O=ga,a=[],xa=1E7;B(H,c);j("destroy",ea);j("init",fa);j("getOption",function(a){return O[a]});j("setOption",function(a,b){ea();O[a]=b;fa()});j("insertSlide",function(b,c,e){ea();c>k&&(c=k);b="<li>"+b+"</li>";!c||0==c?q.prepend(b):n.eq(c-1).after(b);(c<=L||!c||0==c)&&L++;a[15].length<c&&(a[15].length=c);a[15].splice(c,0,e||o(c)+1);fa()});j("removeSlide",function(b){b--;ea();n.eq(b).remove();
