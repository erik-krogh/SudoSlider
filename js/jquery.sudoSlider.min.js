...
u-1;F=f;oa=[];ga=d;D.css({overflow:"hidden"});"static"==D.css("position")&&D.css({position:"relative"});z.css({"float":"left",listStyle:"none"});w.add(z).css({display:"block",position:"relative"});e[8]=parseInt(e[8],10);B=e[8];e[8]+=e[9]-1;e[10]=parseInt(e[10],10)||1;e[0]||(e[0]="slide");e[0]=j(e[0]);e[16]&&(C=[]);for(b=0;b<u;b++)e[19][b]=e[19][b]||b+1,e[31][b]=e[31][b]||d;G=[];for(var c=0;c<u;c++)G[c]=[],G[c].push(z.eq(c));if(C){for(c=e[8];1<=c&&0<u;c--){var p=E(-e[8]+c-1),Fa=E(e[8]-c),k=z.eq(p).clone();
C.push(k);var t=z.eq(Fa).clone();C.push(t);G[p].push(k);G[Fa].push(t);w.prepend(k).append(t)}I=w.children("li")}e[5]=e[5]&&!e[16];w[e[7]?"height":"width"](9E6);I=w.children("li");e[29]=e[29]&&!e[11];e[11]&&(g(ha).on("resize focus",h).resize(),setTimeout(h));O=d;if(e[3]){O=g("<span "+e[36]+"></span>");g(D)[e[6]?"after":"before"](O);if(e[18]){ba=O.prepend("<ol "+e[37]+"></ol>").children();c=e[18]==la?B:1;for(b=0;b<u-(e[16]||e[18]==la?1:B)+1;b+=c)oa[b]=g("<li rel='"+(b+1)+"'><a href='#'><span>"+e[19][b]+
"</span></a></li>").appendTo(ba).click(function(){l(g(this).attr("rel")-1,f);return d})}e[17]&&(ca=y(e[35],ea),da=y(e[34],ma))}c=[4,1,14];for(b in c)e[parseInt(c[b],10)]=parseInt(e[c[b]],10)||0==e[c[b]]?parseInt(e[c[b]],10):"fast"==e[c[b]]?200:"normal"==e[c[b]]||"medium"==e[c[b]]?400:"slow"==e[c[b]]?600:400;if(e[2])g(document).on("click",e[2],function(){var b;if(b=g(this).attr("rel"))"stop"==b?(e[13]=d,q()):"start"==b?(V=n(e[14]),e[13]=f):"block"==b?F=d:"unblock"==b?F=f:l(b==parseInt(b,10)?b-1:b,
f);return d});M(I.slice(0,e[8]),f,function(){e[13]&&(V=n(e[14]));if(L)pa(L,d);else if(e[27]){var b=g(ha),c;if(c=b.hashchange)c(m);else if(c=g.address)c.change(m);else b.on("hashchange",m);m()}else pa(e[10]-1,d);A(r)});e[31][0]&&qa(0,d,0);if(e[32]===f)for(c=0;c<=na;c++)e[31][c]&&e[10]-1!=c&&qa(c,d,0)}function t(b){return function(c){var e=Ea(b);return j(e)(c)}}function j(b){return g.isArray(b)?t(b):g.isFunction(b)?b:-1!=b.indexOf(",")?(b=b.split(","),t(b)):Da(g.fn.sudoSlider.effects)[b.toLowerCase()]}
